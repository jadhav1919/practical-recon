...
In this step, we perform a deeper DNS investigation to discover:

- SPF records
- External mail services
- Cloud infrastructure
- Third-party integrations
- Additional DNS relationships

---

# Step 1 — Run DNS Lookup Transforms

## Action

Right-click the Domain entity or discovered DNS entities.

Run additional DNS-related transforms.
...
The investigation revealed several connected services and DNS relationships.

## Discovered Infrastructure

| Entity | Purpose |
|---|---|
| `_spf1.mailgun.org` | Mailgun email infrastructure |
| `_spf.salesforce.com` | Salesforce integration |
| `spf.protection.outlook.com` | Microsoft mail protection |
| `_spf.freshsales.io` | Freshsales integration |
| `dns@jomax.net` | DNS-related email contact |
| `ns59.domaincontrol.com` | Name server |
| `ns60.domaincontrol.com` | Name server |

---

# What This Shows

DNS and SPF records often reveal:
